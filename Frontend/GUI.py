...
def QueryModifier(Query):
    ...
    question_words = ["how","what","who","where","when","why","which","whose","whom","can you","what's","where's","how's","will you"]
...
class ChatSection(QWidget):
    ...
    def loadMessages(self):
        """Load new chat messages without breaking scroll"""
    ...
    def SpeechRecogText(self):
        """Update assistant status text (listening, thinking, etc.)"""
    ...
    def addMessage(self, message, color):
        """Add message to chat with smart auto-scroll"""
        ...
        if at_bottom:  # Only scroll if user is already at bottom
...
class InitialScreen(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        gif_label = QLabel()
        movie = QMovie(GraphicsDirectoryPath("Jarvis.gif"))
        max_gif_size_H = int(screen_width*0.35)
        max_gif_size_W = int(screen_width*0.45)
        movie.setScaledSize(QSize(max_gif_size_W, max_gif_size_H))
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        minimize_icon = QIcon(GraphicsDirectoryPath("Minimize-2.png"))
